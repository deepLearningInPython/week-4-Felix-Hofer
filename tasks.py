...
# Your code here:
# -----------------------------------------------
word_frequencies = {token.lower(): 0 for token in tokens}
...
# Your code here:
# -----------------------------------------------
token_to_id = token_to_id = {token: i for i, token in enumerate(tokenize(text))}# Your code here
...
def make_vocabulary_map(documents: list) -> tuple:
    unique_tokens = [tokenize(t) for t in documents][0]
